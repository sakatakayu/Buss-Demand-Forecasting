...
# Date    : 3/15/2018
# Purpose : Develop Buss forecasting model based upon departure date,
#           booking date and current bookings from training data. Apply
#           calculated coefficients for additive and multiplictive models
#           to validation data.
# Inputs  : Buss_booking_trainingData.csv, Buss_booking_validationData_revised.csv
...
def BussForecast(trainingDataFile, validationDataFile) :

    ''' Calculate Buss forecast using trainingDataFile to train model
...
def main():
    mase = BussForecast('Buss_booking_trainingData.csv', 'Buss_booking_validationData_revised.csv')
    print mase
